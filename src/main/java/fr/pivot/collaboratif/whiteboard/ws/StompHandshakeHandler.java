...
public class StompHandshakeHandler extends DefaultHandshakeHandler {
     ...
     * @return a {@link StompPrincipal} if both identities are present, {@code null} otherwise
     */
    @Override
    protected Principal determineUser(
        ...
        Long userId = (Long) attributes.get(StompHandshakeInterceptor.ATTR_USER_ID);
        Long tenantId = (Long) attributes.get(StompHandshakeInterceptor.ATTR_TENANT_ID);
